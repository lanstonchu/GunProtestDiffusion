...
where $d$ fulfills [some requirements][10] of having geometric meaning. Therefore we can use a unified distance function $d$ for both time and space. To visualize the space-time metric space, we can plot a 3D scatter plot by using `Plot3D` in Wolfram Language, together with a map of US which is imported by `GeoGraphics` at the respective coordinates range. We will then see a "vessel-shaped" U.S. with "clouds of dust" as her constituents, and the plot looks like a 3D nebula map in astrophysics.

![Image 1 - nebula of gun protest][11]
...
![Image 3 - Mass Shooting Cases][18]
...
![Image 4 - Protest and mass shooting][19]
...
Then we would obtain the $\lambda$ of each cluster by [maximum likelihood estimation][22] (i.e. MLE; EstimatedDistribution in Wolfram Language) as below, where λ1 and λ2 are the spatial and temporal parameters of the respective exponential distributions:-

    distml = Table[EstimatedDistribution[edgeVectorsAllJ[[j, All, i]], ExponentialDistribution[λ]]], {i, 1, 2}];
    {λ1, λ2} = 1/Mean /@ distml;

![Image 6 - Statistics of jump - b][23]
...
![Image 8 - Prediction and Validation of Protests - Small][25]
...
Main notebook: [3 - GeoListPlot.nb][26]
...
![Image 9.8 - GeoListPlot Difussion - Small][27]
...
![Image 9.6 - GeoListPlot Wave - Small][28]
...
![Image 9.5 - GeoListPlot Diffusion and Burst - Small][29]
...
![Image 10 - Prediction of Mass Shooting][30]
...
-----------------
 ...
 - [Maximum likelihood estimation][36]
  ...
  [10]: https://en.wikipedia.org/wiki/Metric_space#Definition
  [11]: http://community.wolfram.com//c/portal/getImageAttachment?filename=1-ProtestPoints-c.gif&userId=1353389
  [12]: https://en.wikipedia.org/wiki/Columbine_High_School_massacre
  [13]: http://methods.sagepub.com/book/handbook-of-data-analysis/n16.xml
  [14]: https://github.com/lanstonchu/GunProtestDiffusion/blob/master/0%20-%20Useful%20Lookup%20List%20and%20Info/0.2%20-%20counties%20distance.nb
  [15]: https://en.wikipedia.org/wiki/Cluster_analysis
  [16]: http://community.wolfram.com//c/portal/getImageAttachment?filename=2-Clusters.gif&userId=1353389
  [17]: https://en.wikipedia.org/wiki/Threshold_model
  [18]: http://community.wolfram.com//c/portal/getImageAttachment?filename=3-massshootingcases.gif&userId=1353389
  [19]: http://community.wolfram.com//c/portal/getImageAttachment?filename=4-protestandmassshooting.gif&userId=1353389
  [20]: https://en.wikipedia.org/wiki/Spanning_tree
  [21]: http://community.wolfram.com//c/portal/getImageAttachment?filename=5-graphofclustering.gif&userId=1353389
  [22]: https://en.wikipedia.org/wiki/Maximum_likelihood_estimation
  [23]: http://community.wolfram.com//c/portal/getImageAttachment?filename=6-StatisticofSpacialDiffusionJump-b.gif&userId=1353389
  [24]: http://community.wolfram.com//c/portal/getImageAttachment?filename=7-Prediction-Protest.jpg&userId=1353389
  [25]: http://community.wolfram.com//c/portal/getImageAttachment?filename=8-predictionand2datavalidation-Small.gif&userId=1353389
  [26]: https://github.com/lanstonchu/GunProtestDiffusion/blob/master/2%20-%20Main%20Analysis/3%20-%20GeoListPlot.nb
  [27]: http://community.wolfram.com//c/portal/getImageAttachment?filename=9.8-GeoDiffusion-Small.gif&userId=1353389
  [28]: http://community.wolfram.com//c/portal/getImageAttachment?filename=9.6-GeoWave-Small.gif&userId=1353389
  [29]: http://community.wolfram.com//c/portal/getImageAttachment?filename=9.5-GeoDiffusionandWave-Small.gif&userId=1353389
  [30]: http://community.wolfram.com//c/portal/getImageAttachment?filename=10-Prediction-MassShooting.jpg&userId=1353389
  [31]: http://community.wolfram.com//c/portal/getImageAttachment?filename=infotable.png&userId=1353389
