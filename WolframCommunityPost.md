...
Main folder: [1 - Data Retrieving][6]

This project utilizes data from [Count Love][7] for protests and [Mass Shooting Tracker (MST)][8] for mass shootings. Count Love is a new database founded by researchers at Boston University and MIT, and MST is a database featured by CNN, MSNBC, The New York Times, The Washington Post, The Economist and more. They are both crowd-sourced database, which is a sensible choice of data for this project, especially when [the Congress is not funding on gun-violence data and researches][9].
...
Main notebook: [2 - analysis - Main.nb][10]
...
where $d$ fulfills [some requirements][11] of having geometric meaning. Therefore we can use a unified distance function $d$ for both time and space. To visualize the space-time metric space, we can plot a 3D scatter plot by using `Plot3D` in Wolfram Language, together with a map of US which is imported by `GeoGraphics` at the respective coordinates range. We will then see a "vessel-shaped" U.S. with "clouds of dust" as her constituents, and the plot looks like a 3D nebula map in astrophysics.

![Image 1 - nebula of gun protest][12]
...
![Image 3 - Mass Shooting Cases][19]
...
![Image 4 - Protest and mass shooting][20]
...
![Image 5 - Tree of diffusion - fast][22]
...
![Image 7 - Prediction of Protests][25]
...
![Image 8 - Prediction and Validation of Protests - Small][26]
...
Main notebook: [3 - GeoListPlot.nb][27]
...
![Image 9.8 - GeoListPlot Difussion - Small][28]
...
![Image 9.6 - GeoListPlot Wave - Small][29]
...
![Image 9.5 - GeoListPlot Diffusion and Burst - Small][30]
...
![Image 10 - Prediction of Mass Shooting][31]
...
Source Code and Data: [GitHub repository][33]
...
-----------------
 ...
 - [Maximum likelihood estimation][36]
  ...
  [5]: http://community.wolfram.com//c/portal/getImageAttachment?filename=9.8-GeoDiffusion-Small.gif&userId=1353389
  [6]: https://github.com/lanstonchu/GunProtestDiffusion/tree/master/1%20-%20Data%20Retrieving
  [7]: https://countlove.org/
  [8]: https://www.massshootingtracker.org/
  [9]: https://www.nytimes.com/2018/03/12/health/gun-violence-research-cdc.html
  [10]: https://github.com/lanstonchu/GunProtestDiffusion/blob/master/2%20-%20Main%20Analysis/2%20-%20analysis%20-%20Main.nb
  [11]: https://en.wikipedia.org/wiki/Metric_space#Definition
  [12]: http://community.wolfram.com//c/portal/getImageAttachment?filename=1-ProtestPoints-c.gif&userId=1353389
  [13]: https://en.wikipedia.org/wiki/Columbine_High_School_massacre
  [14]: http://methods.sagepub.com/book/handbook-of-data-analysis/n16.xml
  [15]: https://github.com/lanstonchu/GunProtestDiffusion/blob/master/0%20-%20Useful%20Lookup%20List%20and%20Info/0.2%20-%20counties%20distance.nb
  [16]: https://en.wikipedia.org/wiki/Cluster_analysis
  [17]: http://community.wolfram.com//c/portal/getImageAttachment?filename=2-Clusters.gif&userId=1353389
  [18]: https://en.wikipedia.org/wiki/Threshold_model
  [19]: http://community.wolfram.com//c/portal/getImageAttachment?filename=3-massshootingcases.gif&userId=1353389
  [20]: http://community.wolfram.com//c/portal/getImageAttachment?filename=4-protestandmassshooting.gif&userId=1353389
  [21]: https://en.wikipedia.org/wiki/Spanning_tree
  [22]: http://community.wolfram.com//c/portal/getImageAttachment?filename=5-treeofclustering-fast.gif&userId=1353389
  [23]: https://en.wikipedia.org/wiki/Maximum_likelihood_estimation
  [24]: http://community.wolfram.com//c/portal/getImageAttachment?filename=6-StatisticofSpacialDiffusionJump-b.gif&userId=1353389
  [25]: http://community.wolfram.com//c/portal/getImageAttachment?filename=7-Prediction-Protest.jpg&userId=1353389
  [26]: http://community.wolfram.com//c/portal/getImageAttachment?filename=8-predictionand2datavalidation-Small.gif&userId=1353389
  [27]: https://github.com/lanstonchu/GunProtestDiffusion/blob/master/2%20-%20Main%20Analysis/3%20-%20GeoListPlot.nb
  [28]: http://community.wolfram.com//c/portal/getImageAttachment?filename=9.8-GeoDiffusion-Small.gif&userId=1353389
  [29]: http://community.wolfram.com//c/portal/getImageAttachment?filename=9.6-GeoWave-Small.gif&userId=1353389
  [30]: http://community.wolfram.com//c/portal/getImageAttachment?filename=9.5-GeoDiffusionandWave-Small.gif&userId=1353389
  [31]: http://community.wolfram.com//c/portal/getImageAttachment?filename=10-Prediction-MassShooting.jpg&userId=1353389
  [32]: http://community.wolfram.com//c/portal/getImageAttachment?filename=infotable-small.png&userId=1353389
  [33]: https://github.com/lanstonchu/GunProtestDiffusion
  [34]: https://en.wikipedia.org/wiki/Cluster_analysis
  [35]: https://en.wikipedia.org/wiki/Spanning_tree
  [36]: https://en.wikipedia.org/wiki/Maximum_likelihood_estimation
